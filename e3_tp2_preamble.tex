...
\titlespacing*{\section}
  {0pt}{6\baselineskip}{1\baselineskip}
...
\hyphenation{rea-li-za-ron}
\hyphenation{fa-bri-can-te}
\hyphenation{co-rres-pon-de}
\hyphenation{ló-gi-cas}
\hyphenation{co-rrec-tos}
\hyphenation{pa-rá-me-tros}
\hyphenation{man-te-ner-se}
\hyphenation{mi-dien-do}
\hyphenation{es-ta-ble-ci-mien-to}
\hyphenation{ge-ne-ra}
\hyphenation{vi-sua-li-zó}
\hyphenation{co-mer-cial}
\hyphenation{a-sin-cró-ni-co}
